...
Por otro lado, destacamos como al incrementar el nivel de la DWT utilizada se pierde más calidad, por lo que podríamos pensar que las imágenes con objetos están siendo mejor reconstruidas que las del cielo. No obstante, esto es simplemente un caso de utilizar una DWT de mayor nivel. Por tanto, no podemos llegar a una conclusión exacta de cual de las dos está obteniendo un mejor resultado, ya que las imágenes del cielo presenta un detrimiento considerable de la calidad y un menor ruido, mientras que las imágenes con objetos presentan un ruido considerable, pero mantienen una calidad aceptable.
